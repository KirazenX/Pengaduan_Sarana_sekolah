        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Buat kategori baru untuk aspirasi.</p>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ket_kategori" id="ket_kategori" class="form-control" value="{{ old('ket_kategori') }}" required>
                            @error('ket_kategori')
