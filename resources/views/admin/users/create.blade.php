    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4>Tambah Akun Pengguna</h4>
                    <p class="text-muted mb-0">Buat akun baru untuk siswa atau admin.</p>
                </div>
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="mb-3" id="nis-field" style="display: {{ old('role', 'siswa') == 'siswa' ? 'block' : 'none' }};">
                    ...
                    <div class="mb-3" id="kelas-field" style="display: {{ old('role', 'siswa') == 'siswa' ? 'block' : 'none' }};">
